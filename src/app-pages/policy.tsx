  ...
  return (
    <main style={{ padding: "100px 30px" }}>
      ...
      <p>
        ...
        безопасности персональных данных. Предпринимает их ИП Калинин Алексей
        олегович (далее — Оператор).
      </p>
      <p>
      ...
      <p>
        ...
        <a
          ...
          href="https://project-isolation.ru"
        >
          https://project-isolation.ru
        </a>
        .
      </p>
      ...
      <p>
        2.3. Сайт — совокупность графических и информационных материалов, а
      ...
      <p>
        5.8. Не происходит передачи персональных данных при получении
        пользователем промокодов, (https://esmoll.ru/) купонов или иных акций и
      ...
      <p>
        7.2. Персональные данные Пользователя никогда, ни при каких условиях не
      ...
      <p>
        7.3. В случае выявления неточностей в персональных данных, Пользователь
        ...
        <a
          ...
          href="mailto:isolation-quest@yandex.ru"
        >
          isolation-quest@yandex.ru
        </a>{" "}
      ...
      <p>
        7.8. При осуществлении доставки товаров Оператор может собирать данные о
        конечной точке доставки и получателе, чтобы точно рассчитать маршрут.
        Грузоперевозка осуществляется с помощью транспортных компаний и
        курьерских служб доставки. Цены по тарифам перевозчика в зависимости от
        объёма и массы груза, а так же удалённости от точки отправки.
      </p>
      <p>
      ...
      <p>
        ...
        <a
          ...
          href="https://project-isolation.ru/policy"
        >
          https://project-isolation.ru/policy
        </a>
        .
      </p>
    </main>
